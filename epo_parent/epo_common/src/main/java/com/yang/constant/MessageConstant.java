...
public class MessageConstant {
    public static final String DELETE_CHECKITEM_FAIL = "删除防疫项失败";
    public static final String DELETE_CHECKITEM_SUCCESS = "删除防疫项成功";
    public static final String ADD_CHECKITEM_SUCCESS = "新增防疫项成功";
    public static final String ADD_CHECKITEM_FAIL = "新增防疫项失败";
    public static final String EDIT_CHECKITEM_FAIL = "编辑防疫项失败";
    public static final String EDIT_CHECKITEM_SUCCESS = "编辑防疫项成功";
    public static final String QUERY_CHECKITEM_SUCCESS = "查询防疫项成功";
    public static final String QUERY_CHECKITEM_FAIL = "查询防疫项失败";
    public static final String UPLOAD_SUCCESS = "上传成功";
    public static final String ADD_CHECKGROUP_FAIL = "新增防疫组失败";
    public static final String ADD_CHECKGROUP_SUCCESS = "新增防疫组成功";
    public static final String DELETE_CHECKGROUP_FAIL = "删除防疫组失败";
    public static final String DELETE_CHECKGROUP_SUCCESS = "删除防疫组成功";
    public static final String QUERY_CHECKGROUP_SUCCESS = "查询防疫组成功";
    public static final String QUERY_CHECKGROUP_FAIL = "查询防疫组失败";
    public static final String EDIT_CHECKGROUP_FAIL = "编辑防疫组失败";
    public static final String EDIT_CHECKGROUP_SUCCESS = "编辑防疫组成功";
